                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="zfood/img/carousel-1.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h1>Best <span>Quality</span> Ingredients</h1>
                            <p>
                                Welcome to Burger King, Dhanmondi, where you can experience the most exquisite Indian, Thai, and Chinese cuisines and enjoy our warm hospitality in a friendly environment. 
                            </p>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-zfood/img">
                            <img src="zfood/img/carousel-2.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h1>World’s <span>Best</span> Chef</h1>
                            <p>
                                Our chefs have crafted the tastiest dishes that tantalize your taste buds and make your dining experience memorable. Come and savor the flavors of India, Thailand, and China with us. So, what are you waiting for? Start your culinary adventure today with Reserveit.
                            </p>
                            <div class="carousel-btn">
                                <a class="btn custom-btn" href="">View Menu</a>
                                <a class="btn custom-btn" href="">Book Table</a>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="zfood/img/carousel-3.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
        ...
        <div class="about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="zfood/img/about.jpg" alt="Image">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="snacks" class="container tab-pane fade">
                            <div class="row">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="{{asset('zfood/img/menu-snack-img.jpg')}}" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div id="beverages" class="container tab-pane fade">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="{{('zfood/img/menu-beverage.jpg')}}" alt="Image">
                                        </div>
                                        <div class="menu-text">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="zfood/img/team-1.jpg" alt="Image">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="zfood/img/team-2.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="zfood/img/team-3.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="zfood/img/team-4.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="owl-carousel testimonials-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="zfood/img/testimonial-1.jpg" alt="Image">
                        </div>
                        <p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="zfood/img/testimonial-2.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="zfood/img/testimonial-3.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="zfood/img/testimonial-4.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="row contact-form">
                    <div class="col-md-6">
                        <iframe src="{{asset('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3001156.4288297426!2d-78.01371936852176!3d42.72876761954724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccc4bf0f123a5a9%3A0xddcfc6c1de189567!2sNew%20York%2C%20USA!5e0!3m2!1sen!2sbd!4v1600663868074!5m2!1sen!2sbd')}}" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                    <div class="col-md-6">
                        <div id="success"></div>
