@extends('zfood.layouts.app')  <!--header/footer -->

@section('title','menu');   <!-- title change-->

@section('main')   <!-- main part-->
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        ...
                                        <div class="menu-text">
                                            <h3><span>Mumbai Chicken</span> <strong>$9.00</strong></h3>
                                            <p>Masala fried chicken, scallion yogurt, mint chutney, pickled red onion.</p>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <div class="menu-img">
                                        ...
                                        <div class="menu-text">
                                            ...
                                            <p>double beef, tomato, green leaf lettuce, red onion, secret sauce, cheese</p>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <div class="menu-img">
                                        ...
                                        <div class="menu-text">
                                            ...
                                            <p>double beef, ponir, fried masala egg, fried onion, cucumber, beef nihari</p>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <div class="menu-img">
                                        ...
                                        <div class="menu-text">
                                            ...
                                            <p>smashed patty, onion, cheddar, secret sauce</p>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <div class="menu-img">
                                        ...
                                        <div class="menu-text">
                                            ...
                                            <p>60 gms beef patty, cheese, dijon mustard, ketchup, mayonnaise, pickles, onion</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        ...
                                        <div class="menu-text">
                                            ...
                                            <p>tandoori spice, yoghurt marinade, chicken thigh, mint chutney, slice cucumbers</p>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <div class="menu-img">
